                    ...
                    <form action="{{ route('admin.permissions.update', $permission) }}" method="POST">
                        ...
                        <div class="card-body p-4">
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              ...
                                              name="description" 
                                              rows="3" 
                                              placeholder="Description de la permission...">{{ old('description', $permission->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="alert alert-warning bg-warning bg-opacity-10 border-0 mt-4">
                                ...
                                <p class="mb-2">Cette permission est actuellement attribuée aux rôles suivants :</p>
